...
class OKRequest {
    ...
    OKRequest(String methodType, String url, Map<String, String> paramsMap, Map<String, String> headerMap,
            OKCallBack callBack) {
    ...
    private OKRequest(String methodType, String url, String jsonStr, Map<String, String> paramsMap,
